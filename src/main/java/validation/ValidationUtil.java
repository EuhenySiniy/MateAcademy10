...
public class ValidationUtil {
    ...
    private static final String DATE = "[0-9]{4}-(0[1-9]|1[0-12])-(0[1-9]|1[0-9]|2[0-9]|3[01])";
    private static final String IP_ADRESS = "((25[0-5]|2[0-4]\\d|[01]?\\d\\d?)\\.){3}(25[0-5]|2[0-4]\\d|[01]?\\d\\d?)";
